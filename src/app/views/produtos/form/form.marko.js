...
function render(input, out, __component, component, state) {
  ...
  out.w("<input type=hidden id=id name=id" +
    ...
    "><section class=form-group><label for=nome>Nome:</label><input type=text id=nome name=nome" +
    marko_attr("value", data.produto.nome) +
    " placeholder=\"digite o nome do produto\"></section><section class=form-group><label for=laboratorio>Laboratorio:</label><input type=text id=laboratorio name=laboratorio" +
    marko_attr("value", data.produto.laboratorio) +
    " placeholder=\"digite o laboratorio do produto\"></section><section class=form-group><label for=preco>Preço:</label><input type=number id=preco name=preco" +
    marko_attr("value", data.produto.preco) +
    " placeholder=\"digite o preco do produto\"></section><section class=form-group><label for=quantidade>Quantidade:</label><input type=number id=preco name=preco" +
    marko_attr("value", data.produto.preco) +
    " placeholder=\"Ex.: 17\"></section><section class=form-group><label for=descricao>Descricao:</label><textarea cols=20 rows=10 id=descricao name=descricao placeholder=\"digite a descricao do produto\"> " +
    marko_escapeXml(data.produto.descricao) +
    " </textarea></section><input type=submit value=Salvar></form></section></main><footer><script src=https://code.jquery.com/jquery-3.5.1.slim.min.js integrity=sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj crossorigin=anonymous></script><script src=https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js integrity=sha384-ho+j7jyWK8fNQe+A12Hb8AhRq26LrZ/JpcUGGOn+Y7RsweNrtN/tE3MoK7ZeZDyx crossorigin=anonymous></script></footer>");
